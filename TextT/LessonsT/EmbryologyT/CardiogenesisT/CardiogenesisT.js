...
$(function(){
    ...
    $('#menu14').on('click', function () { currentSlide = 51; clickedLink = true; }); // Flow Routes
    ...
    $('#menu18').on('click', function () { currentSlide = 82; clickedLink = true; }); // Prenatal Circulation
    $('#menu19').on('click', function () { currentSlide = 93; clickedLink = true; }); // Postnatal Circulation
});
