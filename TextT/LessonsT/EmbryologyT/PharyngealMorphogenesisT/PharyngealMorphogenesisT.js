...
$(function(){
    ...
    $('#menu5').on('click', function () { currentSlide = 11; clickedLink = true; }); // Facial Morphogenesis
    $('#menu6').on('click', function () { currentSlide = 14; clickedLink = true; }); // Photomicrographs & SEMs
});