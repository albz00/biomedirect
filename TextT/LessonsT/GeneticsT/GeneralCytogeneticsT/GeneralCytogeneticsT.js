...
$(function(){
    ...
    $('#menu13').on('click', function () { currentSlide = 50; clickedLink = true; }); // Terminal Translocation (Partial Trisomy)
    $('#menu14').on('click', function () { currentSlide = 54; clickedLink = true; }); // Robertsonian Translocation
});
