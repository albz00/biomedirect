...
$(function(){
    ...
    $('#menu5').on('click', function () { currentSlide = 36; clickedLink = true; }); // Sample Problem, Two Point Cross
    $('#menu6').on('click', function () { currentSlide = 45; clickedLink = true; }); // Sample Problem, Three Point Cross
    $('#menu7').on('click', function () { currentSlide = 67; clickedLink = true; }); // Linkage Maps
});
