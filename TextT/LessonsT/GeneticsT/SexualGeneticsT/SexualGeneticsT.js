...
$(function(){
    ...
    $('#menu4').on('click', function () { currentSlide = 11; clickedLink = true; }); // Barr Bodies
    $('#menu5').on('click', function () { currentSlide = 14; clickedLink = true; }); // Calico Cats
    $('#menu6').on('click', function () { currentSlide = 15; clickedLink = true; }); // Mosaic Ladies
});
