...
$(function () {
	// Side Buttons
    $("#btnSideFpump").on({
		mouseup: function () { $(this).attr('src', 'Fpump/BTN_FpumpOver.jpg'); },
		mousedown: function () { $(this).attr('src', 'Fpump/BTN_FpumpHit.jpg'); },
		mouseenter: function () { $(this).attr('src', 'Fpump/BTN_FpumpOver.jpg'); },
		mouseleave: function () { $(this).attr('src', 'Fpump/BTN_Fpump.jpg'); }
	});
